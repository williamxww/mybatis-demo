 ...
 * 
 * @author vivid 2015-1-29
 */
public class BooleanTypeHandler implements TypeHandler<Boolean> {

    /**
     * 获取数据结果集时如何把数据库类型转换为对应的Java类型 从结果集根据列名取出值然后转换成boolean
     */
     ...
     * @throws SQLException
     */
    public void setParameter(PreparedStatement prep, int parameterIndex, Boolean javaType, JdbcType dbtype)
            throws SQLException {

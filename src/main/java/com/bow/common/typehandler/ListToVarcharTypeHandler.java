package com.bow.common.typehandler;
...
public class ListToVarcharTypeHandler extends BaseTypeHandler<List> {
    ...
    @Override
    public List getNullableResult(CallableStatement cstmt, int columnIndex) throws SQLException {

        return transferType(cstmt.getString(columnIndex));
    }

    @Override
    public void setNonNullParameter(PreparedStatement preps, int parameterIndex, List srcParam, JdbcType targetParam)
            throws SQLException {
